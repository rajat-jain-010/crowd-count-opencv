...
def resize_frame(frame, target_width, target_height):
    return cv.resize(frame, (target_width, target_height))

def counting(video_path=r'C:\Users\Rajat\Desktop\CrowdSense\Test Files\TestVideo\TestVideo.mp4'):
    try:
        log = open('log.txt',"w")
    except:
    ...
    out = cv.VideoWriter('output_frame.mp4', fourcc, 20.0, (640,520))  # Adjust the parameters as needed
    out2 = cv.VideoWriter("output_mask.mp4", fourcc, 20.0, (640,520), isColor=False)
    ...
    #Read an image from the video source
        ...
        if ret==True:
            frame = resize_frame(frame,640,520)
...
# counting(r"C:\Users\Rajat\Desktop\CrowdSense\Test Files\TestVideo\test_1.mp4")